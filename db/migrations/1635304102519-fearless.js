...
module.exports = class fearless1635304102519 {
    name = 'fearless1635304102519'

    async up(queryRunner) {
        await queryRunner.query(`CREATE TABLE "transfer" ("id" character varying NOT NULL, "amount" text, "to" text, "from" text, "event_idx" text, "extrinisic_idx" text NOT NULL, "success" boolean, CONSTRAINT "PK_fd9ddbdd49a17afcbe014401295" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "fees_paid" ("id" character varying NOT NULL, "extrinisic_idx" text NOT NULL, "fee" numeric NOT NULL, "block_producer_address" text NOT NULL, "transfer_id" character varying NOT NULL, CONSTRAINT "REL_06e43c38f77671e127cceab27f" UNIQUE ("transfer_id"), CONSTRAINT "PK_0b92b5f61752bd99bc4864c114d" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_06e43c38f77671e127cceab27f" ON "fees_paid" ("transfer_id") `);
        ...
        await queryRunner.query(`ALTER TABLE "fees_paid" ADD CONSTRAINT "FK_06e43c38f77671e127cceab27f0" FOREIGN KEY ("transfer_id") REFERENCES "transfer"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE "fees_paid" DROP CONSTRAINT "FK_06e43c38f77671e127cceab27f0"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_06e43c38f77671e127cceab27f"`);
